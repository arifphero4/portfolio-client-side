    ...
    <div>
      <div className="min-h-screen bg-gray-900 py-32">
         <div className="container mx-auto px-4 grid items-center grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
               <h1 className="text-gray-100 font-bold text-3xl transition-all duration-300 ease-linear transform scale-100 hover:scale-105">Hello! I'm Arif hasan...</h1>
               <h3 className="text-yellow-500 font-bold text-xl transition-all duration-300 ease-linear transform scale-100 hover:scale-105">I'm a Frond ent web developer</h3>
